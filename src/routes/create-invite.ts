...
export async function createInvite (app: FastifyInstance){
  app.withTypeProvider<ZodTypeProvider>().post('/trips/:tripId/invites', {
    ...
    // confirm link mobile
        // const confirmationLink = new URL (`planner://trip/${trip.id}/?participant=${participant.id}`, "http://10.0.0.149:3000")
        ...
        const message = await mail.sendMail({
          ...
          html: `
            <div style="font-family: sans-serif; font-size: 17px; line-height: 1.6;">
